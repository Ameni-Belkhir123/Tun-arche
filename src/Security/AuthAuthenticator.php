...
class AuthAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        error_log('reCAPTCHA API response: ' . print_r($data, true));
        if (!isset($data['success']) || !$data['success']) {
            $errors = isset($data['error-codes']) ? implode(', ', $data['error-codes']) : 'none';
            error_log('reCAPTCHA verification failed. Error codes: ' . $errors);
