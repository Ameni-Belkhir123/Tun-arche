...
final class PublicationControllerTest extends WebTestCase{
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'publication[date_act]' => 'Something New',
        ]);

        self::assertResponseRedirects('/pub/');
        ...
        self::assertSame('Something New', $fixture[0]->getDate_act());
    }
